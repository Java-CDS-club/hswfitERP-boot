...
import com.hswift.erp.datasource.entities.Tenant;
import com.hswift.erp.datasource.entities.User;
import com.hswift.erp.datasource.entities.UserEx;
...
/**
 * @author ji_sheng_hua HansonSwift erp
 */
@RestController
...
public class UserController {
    ...
    public String updatePwd(@RequestBody JSONObject jsonObject, HttpServletRequest request)throws Exception {
        ...
        try {
            ...
            String md5Pwd = Tools.md5Encryp(password);
            //必须和原始密码一致才可以更新密码
            if(user.getLoginName().equals("hswift")){
                flag = 3; //hswift用户不能修改密码
                info = "hswift用户不能修改密码";
