...
@WebFilter(filterName = "LogCostFilter", urlPatterns = {"/*"},
        initParams = {@WebInitParam(name = "ignoredUrl", value = ".ico"),
                      @WebInitParam(name = "filterPath",
                              value = "/hswiftERP-boot/user/login#/hswiftERP-boot/user/registerUser#/hswiftERP-boot/user/randomImage" +
                                      "#/hswiftERP-boot/platformConfig/getPlatformName#/hswiftERP-boot/v2/api-docs#/hswiftERP-boot/webjars")})
